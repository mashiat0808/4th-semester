...
uint32_t K[64] = {
    ...
    uint32_t m_state[]= { 0x6a09e667,0xbb67ae85, 0x3c6ef372, 0xa54ff53a, 0x510e527f,0x9b05688c, 0x1f83d9ab,0x5be0cd19};
    uint8_t m_data[100] = {0};
    uint8_t m_blocklen;
   uint8_t m_bitlen;
void transform();
void pad();
...
int main() {
		...
		update(s);
		uint8_t * digest1 = digest();

		cout << toString(digest1) << endl;
